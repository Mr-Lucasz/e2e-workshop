...
export const filterElements = {
  ...
  filterPriceLowToHigh:
    "[data-test = product-sort-container]>option:nth-child(3)",
  filterPriceHighToLow:
    "[data-test = product-sort-container]>option:nth-child(4)",
...
export const addCartElements = {
  buttonAdd: '[data-test="add-to-cart-sauce-labs-fleece-jacket"]',
